...
from qiskit.transpiler.passes.utils.constraint import LeastConflictSolver
from qiskit.transpiler.layout import Layout
from qiskit.transpiler.basepasses import AnalysisPass
from .layout_scorer import LayoutScorer


class CspLcsLayout(AnalysisPass):
    """If possible, chooses a Layout as a CSP, using backtracking."""

    def __init__(self, coupling_map, strict_direction=False, seed=None, 
                 call_limit=1000, time_limit=10, iteration_limit=1):
        """If possible, chooses a Layout as a CSP, using backtracking.
        ...
        * iteration limit reached: If no perfect layout was found and the iteration limit was reached.
        ...
        self.csp_solver = LeastConflictSolver(call_limit=self.call_limit,
